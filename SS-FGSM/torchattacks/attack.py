...
class Attack(object):
    ...
    def __call__(self, cluster_idx, tempsup_idx, *input, **kwargs):
    #def __call__(self, noise_cluster, noise_sup,  *input, **kwargs):
        training_mode = self.model.training
        ...
        images = self.forward(cluster_idx, tempsup_idx, *input, **kwargs)
        #images = self.forward(noise_cluster, noise_sup,  *input, **kwargs)
